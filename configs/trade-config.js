...
export const RSI_LONG_LEVEL_SETTING = { min: 1, max: 100, step: 1 };
export const RSI_SHORT_LEVEL_SETTING = { min: 1, max: 100, step: 1 };
export const LEVERAGE_SETTING = { min: 1, max: 5, step: 1 };
export const RANDOM_SAMPLE_NUMBER = 100000; // number or null
